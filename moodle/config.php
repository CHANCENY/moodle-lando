...
$CFG->dbname    = 'lamp';     // database name, eg moodle
$CFG->dbuser    = 'lamp';   // your database username
$CFG->dbpass    = 'lamp';   // your database password
...
$CFG->wwwroot   = 'https://moodle-project.lndo.site';
